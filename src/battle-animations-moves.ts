...
BattleMoveAnims['mindrage'] = {anim: BattleMoveAnims['psychoboost'].anim};
BattleMoveAnims['flowerblessing'] = {anim: BattleMoveAnims['floralhealing'].anim};
BattleMoveAnims['oasismedicine'] = {anim: BattleMoveAnims['chillingwater'].anim};
BattleMoveAnims['spectrallullaby'] = {anim: BattleMoveAnims['sing'].anim};
BattleMoveAnims['dragonmist'] = {anim: BattleMoveAnims['strangesteam'].anim};
BattleMoveAnims['electrocution'] = {
	anim(scene, [attacker, defender]) {
		BattleMoveAnims['forcepalm'].anim(scene, [attacker, defender]);
		BattleMoveAnims['wildcharge'].anim(scene, [attacker, defender]);
	},
};
BattleMoveAnims['frostyspin'] = {anim: BattleMoveAnims['icespinner'].anim};
BattleMoveAnims['electrodrain'] = {anim: BattleMoveAnims['paraboliccharge'].anim};
BattleMoveAnims['nuclearflame'] = {anim: BattleMoveAnims['fusionflare'].anim};
BattleMoveAnims['naturecannon'] = {
	anim(scene, [attacker, defender]) {
		BattleMoveAnims['earthpower'].anim(scene, [attacker, defender]);
		BattleMoveAnims['mudshot'].anim(scene, [attacker, defender]);
	},
};
BattleMoveAnims['starburst'] = {anim: BattleMoveAnims['dazzlinggleam'].anim};
BattleMoveAnims['stealthattack'] = {anim: BattleMoveAnims['fakeout'].anim};
BattleMoveAnims['witherwind'] = {anim: BattleMoveAnims['ominouswind'].anim};
BattleMoveAnims['saltfeast'] = {
	anim(scene, [attacker, defender]) {
		BattleMoveAnims['crunch'].anim(scene, [attacker, defender]);
		BattleMoveAnims['stoneedge'].anim(scene, [attacker, defender]);
	},
};
BattleMoveAnims['changeofheart'] = {anim: BattleMoveAnims['recover'].anim};
BattleMoveAnims['highnoon'] = {anim: BattleMoveAnims['scaleshot'].anim};