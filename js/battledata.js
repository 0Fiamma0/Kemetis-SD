...
return prefix+"//raw.githubusercontent.com/0Fiamma0/Roleplay-Showdown/master/";
}();this.
...
{var _window$Config;var options=arguments.length>2&&arguments[2]!==undefined?arguments[2]:{gen:6};
...
if(Dex.prefs('afd')!==false&&((_window$Config=window.Config)!=null&&(_window$Config=_window$Config.server)!=null&&_window$Config.afd||Dex.prefs('afd')||options.afd)){
...
getTeambuilderSpriteData=function getTeambuilderSpriteData(pokemon){var _window$Config2;var gen=arguments.length>1&&arguments[1]!==undefined?arguments[1]:0;
...
if((_window$Config2=window.Config)!=null&&(_window$Config2=_window$Config2.server)!=null&&_window$Config2.afd||Dex.prefs('afd')){
return{
spriteid:spriteid,
