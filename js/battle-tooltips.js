...
if(this.battle.tier.includes('Super Staff Bros')&&clientPokemon!=null&&clientPokemon.volatiles['ok']){
...
stats[_statName3]=Math.floor(stats[_statName3]*1.5);
}
}
}
}
...
var _boostCount3=0;
var targetBoostCount=0;for(var _i54=0,_Object$values8=
Object.values(pokemon.boosts);_i54<_Object$values8.length;_i54++){var _boost3=_Object$values8[_i54];
if(_boost3>0)_boostCount3+=_boost3;
}for(var _i56=0,_Object$values10=
Object.values(target.boosts);_i56<_Object$values10.length;_i56++){var _boost4=_Object$values10[_i56];
if(_boost4>0)targetBoostCount+=_boost4;
}
if(targetBoostCount>=_boostCount3)value.modify(2,"Target has more boosts");
}
if(value.value<=60){
...
for(var _i57=1;_i57<=5&&_i57<=pokemon.side.faintCounter;_i57++){
if(pokemon.volatiles["fallen"+_i57]){
value.abilityModify([1,1.15,1.3,1.45,1.6,1.75][_i57],"Hardcore Hustle");
}
}
...
if(!types)types=this.getPokemonTypes(pokemon);for(var _i59=0,_types2=
types;_i59<_types2.length;_i59++){var curType=_types2[_i59];
...
var origLeftoverEVs=508;for(var _i61=0,_Dex$statNames2=
Dex.statNames;_i61<_Dex$statNames2.length;_i61++){var _origSpread$evs;var stat=_Dex$statNames2[_i61];
...
if(!minusTooLow){for(var _i63=0,_Dex$statNamesExceptH14=
Dex.statNamesExceptHP;_i63<_Dex$statNamesExceptH14.length;_i63++){var _stat=_Dex$statNamesExceptH14[_i63];
...
if(!plusTooHigh){for(var _i65=0,_Dex$statNamesExceptH16=
Dex.statNamesExceptHP;_i65<_Dex$statNamesExceptH16.length;_i65++){var _stat2=_Dex$statNamesExceptH16[_i65];
...
}for(var _i67=0,_Dex$statNames4=
Dex.statNames;_i67<_Dex$statNames4.length;_i67++){var _stat3=_Dex$statNames4[_i67];
...
if(savedEVs<0)return null;for(var _i69=0,_Dex$statNames6=
Dex.statNames;_i69<_Dex$statNames6.length;_i69++){var _stat4=_Dex$statNames6[_i69];
