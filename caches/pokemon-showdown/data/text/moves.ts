export const MovesText: {[k: string]: MoveText} = {
	...
	dragonmist: {
		name: "Dragon Mist",
		desc: "If the current terrain is Misty Terrain and the user is grounded, this move has its power multiplied by 1.5.",
		shortDesc: "User on Misty Terrain: 1.5x power.",
	},
	electrocution: {
		name: "Electrocution",
	...
	starburst: {
		name: "Starburst",
		desc: "Has a 40% chance to lower both the target's defenses by 1 stage.",
		shortDesc: "40% chance to lower the target's defenses by 1.",
	},
	nuclearflame: {
		name: "Nuclear Flame",
		desc: "Cannot be selected the turn after it's used. It may leave the target with a burn.",
		shortDesc: "Cannot be selected twice in a row. 20% brn.",
	},
	naturecannon: {
		name: "Nature Cannon",
	...
	saltfeast: {
		name: "Salt Feast",
		desc: "The user recovers 1/2 the HP lost by the target, rounded half up. If Big Root is held by the user, the HP recovered is 1.3x normal, rounded half down. This move's type effectiveness against Rock is changed to be super effective no matter what this move's type is.",
		shortDesc: "Heals by 50% damage dealt. Super effective on Rock.",
	},
	stealthattack: {
		name: "Stealth Attack",
	...
	witherwind: {
		name: "Wither Wind",
		desc: "Has a 80% chance to lower the target's Special Defense by 1 stage.",
		shortDesc: "80% chance to lower the target's Sp. Def by 1.",
	},
	changeofheart: {
		name: "Change Of Heart",
		desc: "The user restores 1/2 of its maximum HP, rounded half up. If the user is Emutep, it changes form.",
		shortDesc: "Heals for 50% max HP. If Emutep: changes form.",
		activate: "  [POKEMON]'s mood changed!",
	},
	highnoon: {
		name: "High Noon",
