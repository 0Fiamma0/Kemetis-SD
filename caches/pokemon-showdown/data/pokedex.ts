export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	meganium: {
		...
		otherFormes: ["Meganium-Kemetis"],
		formeOrder: ["Meganium", "Meganium-Kemetis"],
	},
	meganiumkemetis: {
		num: 154,
		name: "Meganium-Kemetis",
		baseSpecies: "Meganium",
		forme: "Kemetis",
		types: ["Grass", "Fairy"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 80, atk: 92, def: 85, spa: 113, spd: 85, spe: 80},
	...
	swampert: {
		...
		otherFormes: ["Swampert-Mega", "Swampert-Kemetis"],
		formeOrder: ["Swampert", "Swampert-Mega", "Swampert-Kemetis"],
	},
	swampertkemetis: {
		num: 260,
		name: "Swampert-Kemetis",
		baseSpecies: "Swampert",
		forme: "Kemetis",
		types: ["Water", "Ground"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 100, atk: 110, def: 90, spa: 110, spd: 85, spe: 40},
	...
	delphox: {
		...
		evoLevel: 36,
		eggGroups: ["Field"],
		otherFormes: ["Delphox-Kemetis"],
		formeOrder: ["Delphox", "Delphox-Kemetis"],
	},
	delphoxkemetis: {
		num: 655,
		name: "Delphox-Kemetis",
		baseSpecies: "Delphox",
		forme: "Kemetis",
		types: ["Fire", "Psychic"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 75, atk: 69, def: 72, spa: 118, spd: 85, spe: 115},
	...
	jigglypuff: {
		...
		evos: ["Wigglytuff"],
		eggGroups: ["Fairy"],
		otherFormes: ["Jigglypuff-Kemetis"],
		formeOrder: ["Jigglypuff", "Jigglypuff-Kemetis"],
	},
	jigglypuffkemetis: {
		num: 39,
		name: "Jigglypuff-Kemetis",
		baseSpecies: "Jigglypuff",
		forme: "Kemetis",
		types: ["Ghost", "Fairy"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 20, atk: 20, def: 45, spa: 45, spd: 50, spe: 90},
		abilities: {0: "Cute Charm", 1: "Competitive", H: "Friend Guard"},
		heightm: 0.5,
		weightkg: 5.5,
		color: "Purple",
		evoType: "levelFriendship",
		evos: ["Wigglytuff-Kemetis"],
		eggGroups: ["Fairy"],
	},
	wigglytuff: {
		num: 40,
		...
		evoItem: "Moon Stone",
		eggGroups: ["Fairy"],
		otherFormes: ["Wigglytuff-Kemetis"],
		formeOrder: ["Wigglytuff", "Wigglytuff-Kemetis"],
	},
	wigglytuffkemetis: {
		num: 40,
		name: "Wigglytuff-Kemetis",
		baseSpecies: "Wigglytuff",
		forme: "Kemetis",
		types: ["Ghost", "Fairy"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 50, atk: 69, def: 47, spa: 99, spd: 70, spe: 100},
		abilities: {0: "Cute Charm", 1: "Competitive", H: "Friend Guard"},
		heightm: 0.5,
		weightkg: 5.5,
		color: "Purple",
		prevo: "Jigglypuff-Kemetis",
		evoType: "useItem",
		evoItem: "Moon Stone",
		eggGroups: ["Fairy"],
	},
	cleffakemetis: {
		...
		types: ["Ground", "Fairy"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 50, atk: 25, def: 55, spa: 45, spd: 28, spe: 15},
		abilities: {0: "Sand Veil", 1: "Magic Guard", H: "Friend Guard"},
		heightm: 0.3,
		weightkg: 3,
		color: "Brown",
		evos: ["Clefairy-Kemetis"],
		eggGroups: ["Undiscovered"],
		canHatch: true,
	},
	clefairykemetis: {
		num: 35,
		name: "Clefairy-Kemetis",
		baseSpecies: "Clefairy",
		forme: "Kemetis",
		types: ["Ground", "Fairy"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 70, atk: 45, def: 65, spa: 60, spd: 48, spe: 35},
		abilities: {0: "Sand Veil", 1: "Magic Guard", H: "Friend Guard"},
		heightm: 0.6,
		weightkg: 7.5,
		color: "Brown",
		prevo: "Cleffa-Kemetis",
		evoType: "levelFriendship",
		evos: ["Clefable-Kemetis"],
		eggGroups: ["Fairy"],
	},
	clefablekemetis: {
		num: 36,
		name: "Clefable-Kemetis",
		baseSpecies: "Clefable",
		forme: "Kemetis",
		types: ["Ground", "Fairy"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 95, atk: 70, def: 90, spa: 95, spd: 73, spe: 60},
		abilities: {0: "Sand Veil", 1: "Magic Guard", H: "Unaware"},
		heightm: 1.3,
		weightkg: 40,
		color: "Brown",
		prevo: "Clefairy-Kemetis",
		evoType: "useItem",
		evoItem: "Moon Stone",
		eggGroups: ["Fairy"],
	},
	natukemetis: {
		...
		forme: "Kemetis",
		types: ["Rock", "Flying"],
		baseStats: {hp: 50, atk: 20, def: 45, spa: 75, spd: 45, spe: 85},
		abilities: {0: "Synchronize", 1: "Early Bird", H: "Lapis Flow"},
		heightm: 0.2,
		weightkg: 2,
		color: "Brown",
		evos: ["Xatu-Kemetis"],
	...
	xatukemetis: {
		...
		forme: "Kemetis",
		types: ["Rock", "Flying"],
		baseStats: {hp: 70, atk: 51, def: 70, spa: 110, spd: 70, spe: 99},
		abilities: {0: "Synchronize", 1: "Early Bird", H: "Lapis Flow"},
		heightm: 1.5,
		weightkg: 15,
		color: "Brown",
	...
	swablukemetis: {
		...
		forme: "Kemetis",
		types: ["Steel", "Flying"],
		baseStats: {hp: 50, atk: 40, def: 75, spa: 55, spd: 60, spe: 30},
		abilities: {0: "Sturdy", H: "Bulletproof"},
		heightm: 0.4,
		weightkg: 1.2,
		color: "Gray",
		evos: ["Altaria-Kemetis"],
		eggGroups: ["Flying", "Dragon"],
	},
	altariakemetis: {
		num: 334,
		name: "Altaria-Kemetis",
		baseSpecies: "Altaria",
		forme: "Kemetis",
		types: ["Steel", "Dragon"],
		baseStats: {hp: 80, atk: 70, def: 105, spa: 85, spd: 90, spe: 60},
		abilities: {0: "Sturdy", H: "Bulletproof"},
		heightm: 1.1,
		weightkg: 20.6,
		color: "Gray",
		prevo: "Swablu-Kemetis",
		evoLevel: 35,
		eggGroups: ["Flying", "Dragon"],
	},
	dragonitekemetis: {
		num: 149,
		name: "Dragonite-Kemetis",
		baseSpecies: "Dragonite",
		forme: "Kemetis",
		types: ["Dragon", "Fairy"],
		baseStats: {hp: 90, atk: 80, def: 95, spa: 135, spd: 100, spe: 100},
		abilities: {0: "Cloud Nine", H: "Misty Surge"},
		heightm: 2.2,
		weightkg: 210,
		color: "Blue",
		evoLevel: 55,
	...
	falinkskemetis: {
		num: 870,
		name: "Falinks-Kemetis",
		baseSpecies: "Falinks",
		forme: "Kemetis",
		types: ["Bug"],
		gender: "N",
		baseStats: {hp: 70, atk: 100, def: 100, spa: 50, spd: 75, spe: 75},
	...
	raltskemetis: {
		...
		forme: "Kemetis",
		types: ["Psychic", "Grass"],
		baseStats: {hp: 28, atk: 45, def: 25, spa: 25, spd: 35, spe: 40},
		abilities: {0: "Leaf Guard", 1: "Anticipation", H: "Frisk"},
		heightm: 0.4,
		weightkg: 6.6,
		color: "Green",
		evos: ["Kirlia-Kemetis"],
	...
	kirliakemetis: {
		...
		forme: "Kemetis",
		types: ["Psychic", "Grass"],
		baseStats: {hp: 38, atk: 65, def: 35, spa: 30, spd: 50, spe: 60},
		abilities: {0: "Leaf Guard", 1: "Anticipation", H: "Frisk"},
		heightm: 0.8,
		weightkg: 20.2,
		color: "Green",
		prevo: "Ralts-Kemetis",
		evoLevel: 20,
		evos: ["Gallade-Kemetis"],
		eggGroups: ["Human-Like", "Amorphous"],
	},
	galladekemetis: {
		num: 475,
		name: "Gallade-Kemetis",
		baseSpecies: "Gallade",
		forme: "Kemetis",
		types: ["Psychic", "Grass"],
		baseStats: {hp: 68, atk: 125, def: 65, spa: 50, spd: 110, spe: 100},
		abilities: {0: "Leaf Guard", 1: "Sharpness", H: "Frisk"},
		heightm: 1.6,
		weightkg: 52,
		color: "Green",
		prevo: "Kirlia-Kemetis",
		evoType: "useItem",
		evoItem: "Dawn Stone",
		eggGroups: ["Human-Like", "Amorphous"],
	},
	salazzlekemetis: {
		num: 758,
		name: "Salazzle-Kemetis",
		baseSpecies: "Salazzle",
		forme: "Kemetis",
		types: ["Poison", "Fire"],
		gender: "M",
		baseStats: {hp: 80, atk: 109, def: 95, spa: 44, spd: 60, spe: 92},
		abilities: {0: "Corrosion", 1: "Tough Claws"},
		heightm: 2.1,
		weightkg: 81,
		color: "Black",
		prevo: "Salandit",
	...
	elgyemkemetis: {
		...
		forme: "Kemetis",
		types: ["Electric", "Fire"],
		baseStats: {hp: 55, atk: 85, def: 45, spa: 45, spd: 45, spe: 60},
		abilities: {0: "Telepathy", 1: "Static", H: "Earth Eater"},
		heightm: 0.5,
		weightkg: 6,
		color: "Blue",
		evos: ["Beheeyem-Kemetis"],
		eggGroups: ["Human-Like"],
	},
	beheeyemkemetis: {
		num: 606,
		name: "Beheeyem-Kemetis",
		baseSpecies: "Beheeyem",
		forme: "Kemetis",
		types: ["Electric", "Fire"],
		baseStats: {hp: 75, atk: 125, def: 65, spa: 55, spd: 65, spe: 100},
		abilities: {0: "Telepathy", 1: "Static", H: "Earth Eater"},
		heightm: 1,
		weightkg: 14.5,
		color: "Red",
		prevo: "Elgyem-Kemetis",
		evoLevel: 42,
		eggGroups: ["Human-Like"],
	},
	baltoykemetis: {
		...
		types: ["Ground", "Ice"],
		gender: "N",
		baseStats: {hp: 40, atk: 60, def: 55, spa: 20, spd: 70, spe: 55},
		abilities: {0: "Levitate"},
		heightm: 0.5,
		weightkg: 21.5,
		color: "Brown",
		evos: ["Claydol-Kemetis"],
		eggGroups: ["Mineral"],
	},
	claydolkemetis: {
		num: 344,
		name: "Claydol-Kemetis",
		baseSpecies: "Claydol",
		forme: "Kemetis",
		types: ["Ground", "Ice"],
		gender: "N",
		baseStats: {hp: 60, atk: 100, def: 105, spa: 40, spd: 120, spe: 75},
		abilities: {0: "Levitate"},
		heightm: 1.5,
		weightkg: 108,
		color: "Black",
		prevo: "Baltoy-Kemetis",
		evoLevel: 36,
		eggGroups: ["Mineral"],
	},
	zangoosekemetis: {
		num: 335,
		name: "Zangoose-Kemetis",
		baseSpecies: "Zangoose",
		forme: "Kemetis",
		types: ["Normal", "Steel"],
		baseStats: {hp: 73, atk: 100, def: 95, spa: 40, spd: 60, spe: 90},
		abilities: {0: "Battle Armor", H: "Guts"},
		heightm: 1.3,
		weightkg: 40.3,
		color: "White",
		eggGroups: ["Field"],
	...
	seviperkemetis: {
		num: 336,
		name: "Seviper-Kemetis",
		baseSpecies: "Seviper",
		forme: "Kemetis",
		types: ["Poison", "Ghost"],
		baseStats: {hp: 73, atk: 100, def: 70, spa: 65, spd: 60, spe: 90},
	...
	mareepkemetis: {
		...
		forme: "Kemetis",
		types: ["Electric", "Dark"],
		baseStats: {hp: 55, atk: 50, def: 30, spa: 75, spd: 45, spe: 25},
		abilities: {0: "Static", H: "Minus"},
		heightm: 0.6,
		weightkg: 7.8,
		color: "Black",
		evos: ["Flaaffy-Kemetis"],
		eggGroups: ["Monster", "Field"],
	},
	flaaffykemetis: {
		num: 180,
		name: "Flaaffy-Kemetis",
		baseSpecies: "Flaaffy",
		forme: "Kemetis",
		types: ["Electric", "Dark"],
		baseStats: {hp: 70, atk: 65, def: 45, spa: 90, spd: 60, spe: 35},
		abilities: {0: "Static", H: "Minus"},
		heightm: 0.8,
		weightkg: 13.3,
		color: "Black",
		prevo: "Mareep-Kemetis",
		evoLevel: 15,
		evos: ["Ampharos-Kemetis"],
		eggGroups: ["Monster", "Field"],
	},
	ampharoskemetis: {
		num: 181,
		name: "Ampharos-Kemetis",
		baseSpecies: "Ampharos",
		forme: "Kemetis",
		types: ["Electric", "Dark"],
		baseStats: {hp: 85, atk: 50, def: 90, spa: 120, spd: 90, spe: 75},
		abilities: {0: "Static", H: "Minus"},
		heightm: 1.4,
		weightkg: 61.5,
		color: "Black",
		prevo: "Flaaffy-Kemetis",
		evoLevel: 30,
		eggGroups: ["Monster", "Field"],
	},
	pikipekkemetis: {
		num: 731,
		name: "Pikipek-Kemetis",
		baseSpecies: "Pikipek",
		forme: "Kemetis",
		types: ["Electric", "Flying"],
		baseStats: {hp: 35, atk: 55, def: 50, spa: 20, spd: 40, spe: 65},
		abilities: {0: "Keen Eye", 1: "Static", H: "Pickup"},
		heightm: 0.3,
		weightkg: 1.2,
		color: "Black",
		evos: ["Trumbeak-Kemetis"],
		eggGroups: ["Flying"],
		otherFormes: ["Pikipek-Kemetis"],
		formeOrder: ["Pikipek", "Pikipek-Kemetis"],
	},
	trumbeakkemetis: {
		num: 732,
		name: "Trumbeak-Kemetis",
		baseSpecies: "Trumbeak",
		forme: "Kemetis",
		types: ["Electric", "Flying"],
		baseStats: {hp: 55, atk: 65, def: 70, spa: 30, spd: 60, spe: 75},
		abilities: {0: "Keen Eye", 1: "Static", H: "Pickup"},
		heightm: 0.6,
		weightkg: 14.8,
		color: "Black",
		prevo: "Pikipek-Kemetis",
		evoLevel: 14,
		evos: ["Toucannon-Kemetis"],
		eggGroups: ["Flying"],
		otherFormes: ["Trumbeak-Kemetis"],
		formeOrder: ["Trumbeak", "Trumbeak-Kemetis"],
	},
	toucannonkemetis: {
		num: 733,
		name: "Toucannon-Kemetis",
		baseSpecies: "Toucannon",
		forme: "Kemetis",
		types: ["Electric", "Flying"],
		baseStats: {hp: 80, atk: 100, def: 100, spa: 60, spd: 85, spe: 60},
		abilities: {0: "Keen Eye", 1: "Static", H: "Drizzle"},
		heightm: 1.1,
		weightkg: 26,
		color: "Black",
		prevo: "Trumbeak-Kemetis",
		evoLevel: 28,
		eggGroups: ["Flying"],
		otherFormes: ["Toucannon-Kemetis"],
		formeOrder: ["Toucannon", "Toucannon-Kemetis"],
	},
	ekanskemetis: {
		num: 23,
		name: "Ekans-Kemetis",
		...
		baseStats: {hp: 35, atk: 20, def: 44, spa: 60, spd: 74, spe: 55},
		abilities: {0: "Intimidate", 1: "Wonder Skin", H: "Telepathy"},
		heightm: 2,
		weightkg: 6.9,
		color: "Green",
		evos: ["Arbok-Kemetis"],
	...
	arbokkemetis: {
		...
		forme: "Kemetis",
		types: ["Poison", "Psychic"],
		baseStats: {hp: 60, atk: 33, def: 80, spa: 95, spd: 100, spe: 80},
		abilities: {0: "Intimidate", 1: "Wonder Skin", H: "Telepathy"},
		heightm: 3.5,
		weightkg: 65,
		color: "Green",
	...
	gyaradoskemetis: {
		num: 130,
		name: "Gyarados-Kemetis",
		baseSpecies: "Gyarados",
		forme: "Kemetis",
		types: ["Water", "Ghost"],
		baseStats: {hp: 95, atk: 60, def: 80, spa: 125, spd: 100, spe: 80},
		abilities: {0: "Cursed Body", H: "No Guard"},
		heightm: 6.5,
		weightkg: 235,
		color: "Black",
		prevo: "Magikarp",
	...
	bouffalantkemetis: {
		num: 626,
		name: "Bouffalant-Kemetis",
		baseSpecies: "Bouffalant",
		forme: "Kemetis",
		types: ["Fighting"],
		baseStats: {hp: 75, atk: 120, def: 85, spa: 40, spd: 85, spe: 85},
	...
	solosiskemetis: {
		num: 577,
		name: "Solosis-Kemetis",
		baseSpecies: "Solosis",
		forme: "Kemetis",
		types: ["Water", "Psychic"],
		baseStats: {hp: 40, atk: 20, def: 40, spa: 90, spd: 50, spe: 30},
		abilities: {0: "Overcoat", 1: "Water Absorb", H: "Regenerator"},
		heightm: 0.3,
		weightkg: 1,
		color: "Blue",
		evos: ["Duosion-Kemetis"],
		eggGroups: ["Amorphous"],
	},
	duosionkemetis: {
		num: 578,
		name: "Duosion-Kemetis",
		baseSpecies: "Duosion",
		forme: "Kemetis",
		types: ["Water", "Psychic"],
		baseStats: {hp: 50, atk: 35, def: 50, spa: 105, spd: 60, spe: 45},
		abilities: {0: "Overcoat", 1: "Water Absorb", H: "Regenerator"},
		heightm: 0.6,
		weightkg: 8,
		color: "Blue",
		prevo: "Solosis-Kemetis",
		evoLevel: 32,
		evos: ["Reuniclus-Kemetis"],
		eggGroups: ["Amorphous"],
	},
	reunicluskemetis: {
		num: 579,
		name: "Reuniclus-Kemetis",
		baseSpecies: "Reuniclus",
		forme: "Kemetis",
		types: ["Water", "Psychic"],
		baseStats: {hp: 110, atk: 70, def: 90, spa: 130, spd: 90, spe: 50},
		abilities: {0: "Intimidate", 1: "Water Absorb", H: "Regenerator"},
		heightm: 1,
		weightkg: 20.1,
		color: "Blue",
		prevo: "Duosion-Kemetis",
		evoType: "other",
		evoCondition: "Defeat a Gyarados, a Sharpedo and a Clawitzer and level-up",
		eggGroups: ["Amorphous"],
	},
	foonguskemetis: {
		num: 590,
		name: "Foongus-Kemetis",
		baseSpecies: "Foongus",
		forme: "Kemetis",
		types: ["Grass", "Ground"],
		baseStats: {hp: 69, atk: 55, def: 55, spa: 45, spd: 55, spe: 15},
		abilities: {0: "Effect Spore", H: "Earth Eater"},
		heightm: 0.2,
		weightkg: 1,
		color: "Brown",
		evos: ["Amoonguss-Kemetis"],
		eggGroups: ["Grass"],
	},
	amoongusskemetis: {
		num: 591,
		name: "Amoonguss-Kemetis",
		baseSpecies: "Amoonguss",
		forme: "Kemetis",
		types: ["Grass", "Ground"],
		baseStats: {hp: 114, atk: 90, def: 80, spa: 75, spd: 80, spe: 25},
		abilities: {0: "Effect Spore", H: "Earth Eater"},
		heightm: 0.6,
		weightkg: 10.5,
		color: "Brown",
		prevo: "Foongus-Kemetis",
		evoLevel: 39,
		eggGroups: ["Grass"],
	},
	sableyekemetis: {
		num: 302,
		name: "Sableye-Kemetis",
		baseSpecies: "Sableye",
		forme: "Kemetis",
		types: ["Rock", "Ghost"],
		baseStats: {hp: 50, atk: 80, def: 75, spa: 50, spd: 70, spe: 55},
		abilities: {0: "Purifying Salt", H: "Prankster"},
		heightm: 0.5,
		weightkg: 11,
		color: "Brown",
		eggGroups: ["Human-Like"],
	...
	mawilekemetis: {
		...
		forme: "Kemetis",
		types: ["Rock", "Fairy"],
		baseStats: {hp: 50, atk: 85, def: 85, spa: 45, spd: 60, spe: 55},
	...
	aipomkemetis: {
		...
		abilities: {0: "Run Away", 1: "Pickup", H: "Prankster"},
		heightm: 0.8,
		weightkg: 11.5,
		color: "Black",
		evos: ["Ambipom-Kemetis"],
		eggGroups: ["Field"],
	},
	ambipomkemetis: {
		num: 424,
		name: "Ambipom-Kemetis",
		baseSpecies: "Ambipom",
		forme: "Kemetis",
		types: ["Dark", "Fighting"],
		baseStats: {hp: 75, atk: 105, def: 66, spa: 60, spd: 66, spe: 110},
		abilities: {0: "Technician", 1: "Pickup", H: "Defiant"},
		heightm: 1.2,
		weightkg: 20.3,
		color: "Black",
		prevo: "Aipom-Kemetis",
	...
	zubatkemetis: {
		...
		forme: "Kemetis",
		types: ["Poison", "Ground"],
		baseStats: {hp: 45, atk: 50, def: 45, spa: 25, spd: 40, spe: 40},
		abilities: {0: "Infiltrator", H: "Mold Breaker"},
		heightm: 0.8,
		weightkg: 7.5,
		color: "Brown",
		evos: ["Golbat-Kemetis"],
	...
	golbatkemetis: {
		...
		forme: "Kemetis",
		types: ["Poison", "Ground"],
		baseStats: {hp: 85, atk: 100, def: 75, spa: 50, spd: 70, spe: 75},
		abilities: {0: "Infiltrator", 1: "Rough Skin", H: "Mold Breaker"},
		heightm: 1.6,
		weightkg: 55,
		color: "Brown",
		prevo: "Zubat-Kemetis",
	...
	crobatkemetis: {
		...
		forme: "Kemetis",
		types: ["Poison", "Ground"],
		baseStats: {hp: 105, atk: 130, def: 90, spa: 50, spd: 70, spe: 90},
		abilities: {0: "Infiltrator", 1: "Rough Skin", H: "Mold Breaker"},
		heightm: 1.8,
		weightkg: 75,
		color: "Brown",
		prevo: "Golbat-Kemetis",
		evoType: "levelFriendship",
		eggGroups: ["Field"],
	},
	porygonkemetis: {
		num: 137,
		name: "Porygon-Kemetis",
		baseSpecies: "Porygon",
		forme: "Kemetis",
		types: ["Steel"],
		gender: "N",
		baseStats: {hp: 95, atk: 70, def: 105, spa: 95, spd: 100, spe: 55},
	...
	regipyros: {
		...
		types: ["Fire"],
		gender: "N",
		baseStats: {hp: 120, atk: 110, def: 80, spa: 140, spd: 80, spe: 50},
	...
	regiterra: {
		...
		types: ["Ground"],
		gender: "N",
		baseStats: {hp: 120, atk: 140, def: 80, spa: 110, spd: 80, spe: 50},
	...
	regipixie: {
		...
		types: ["Fairy"],
		gender: "N",
		baseStats: {hp: 80, atk: 120, def: 100, spa: 120, spd: 100, spe: 50},
	...
	lediogre: {
		...
		name: "Lediogre",
		types: ["Bug", "Fighting"],
		baseStats: {hp: 80, atk: 105, def: 80, spa: 65, spd: 110, spe: 80},
	...
	ledyarkle: {
		...
		name: "Ledyarkle",
		types: ["Bug", "Fairy"],
		baseStats: {hp: 70, atk: 55, def: 80, spa: 105, spd: 110, spe: 100},
		abilities: {0: "Swarm", 1: "Dazzling", H: "Tinted Lens"},
		heightm: 1.5,
		weightkg: 40.6,
		color: "White",
		prevo: "Ledian",
	...
	sunflare: {
		...
		name: "Sunflare",
		types: ["Grass", "Fire"],
		baseStats: {hp: 85, atk: 65, def: 85, spa: 125, spd: 105, spe: 50},
	...
	meerserve: {
		...
		baseStats: {hp: 90, atk: 60, def: 80, spa: 105, spd: 80, spe: 110},
		abilities: {0: "Oblivious", 1: "Intimidate", H: "Analytic"},
		heightm: 1.5,
		weightkg: 40,
		color: "White",
		prevo: "Watchog",
	...
	spectrowl: {
		...
		name: "Spectrowl",
		types: ["Ghost", "Flying"],
		baseStats: {hp: 105, atk: 50, def: 70, spa: 100, spd: 100, spe: 75},
		abilities: {0: "Insomnia", 1: "Cursed Body", H: "Tinted Lens"},
		heightm: 1.8,
		weightkg: 55.8,
		color: "Purple",
		prevo: "Noctowl",
	...
	emutep: {
		...
		types: ["Fairy"],
		gender: "N",
		baseStats: {hp: 100, atk: 115, def: 75, spa: 115, spd: 75, spe: 120},
		abilities: {0: "Soulkindle"},
		heightm: 0.8,
		weightkg: 5.5,
		color: "Purple",
		eggGroups: ["Undiscovered"],
		tags: ["Mythical"],
		otherFormes: ["Emutep-Sorrow"],
		formeOrder: ["Emutep", "Emutep-Sorrow"],
	},
	emutepsorrow: {
		num: -9,
		name: "Emutep-Sorrow",
		...
		types: ["Dark"],
		gender: "N",
		baseStats: {hp: 100, atk: 90, def: 120, spa: 90, spd: 120, spe: 80},
		abilities: {0: "Soulshroud"},
		heightm: 0.8,
		weightkg: 5.5,
		color: "Blue",
		eggGroups: ["Undiscovered"],
	...
	zencham: {
		...
		name: "Zencham",
		types: ["Psychic"],
		baseStats: {hp: 100, atk: 80, def: 105, spa: 80, spd: 105, spe: 40},
		abilities: {0: "Peace Of Mind", H: "Telepathy"},
		heightm: 1.6,
		weightkg: 50.6,
		color: "Red",
		prevo: "Medicham",
	...
	cactinger: {
		...
		name: "Cactinger",
		types: ["Grass", "Dark"],
		baseStats: {hp: 96, atk: 115, def: 70, spa: 61, spd: 70, spe: 123},
		abilities: {0: "Water Absorb", 1: "Quick Draw", H: "Rough Skin"},
		heightm: 1.7,
		weightkg: 80.4,
		color: "Green",
		prevo: "Cacturne",
	...
	ekans: {
		...
		evos: ["Arbok"],
		eggGroups: ["Field", "Dragon"],
		otherFormes: ["Ekans-Kemetis"],
		formeOrder: ["Ekans", "Ekans-Kemetis"],
	},
	arbok: {
		num: 24,
		name: "Arbok",
		...
		evoLevel: 22,
		eggGroups: ["Field", "Dragon"],
		otherFormes: ["Arbok-Kemetis"],
		formeOrder: ["Arbok", "Arbok-Kemetis"],
	},
	pikachu: {
		num: 25,
		name: "Pikachu",
	...
	clefairy: {
		...
		evos: ["Clefable"],
		eggGroups: ["Fairy"],
		otherFormes: ["Clefairy-Kemetis"],
		formeOrder: ["Clefairy", "Clefairy-Kemetis"],
	},
	clefable: {
		num: 36,
		name: "Clefable",
		...
		evoItem: "Moon Stone",
		eggGroups: ["Fairy"],
		otherFormes: ["Clefable-Kemetis"],
		formeOrder: ["Clefable", "Clefable-Kemetis"],
	},
	vulpix: {
		num: 37,
		name: "Vulpix",
	...
	zubat: {
		...
		evos: ["Golbat"],
		eggGroups: ["Flying"],
		otherFormes: ["Zubat-Kemetis"],
		formeOrder: ["Zubat", "Zubat-Kemetis"],
	},
	golbat: {
		num: 42,
		name: "Golbat",
		...
		evos: ["Crobat"],
		eggGroups: ["Flying"],
		otherFormes: ["Golbat-Kemetis"],
		formeOrder: ["Golbat", "Golbat-Kemetis"],
	},
	oddish: {
		num: 43,
		name: "Oddish",
	...
	gyarados: {
		...
		evoLevel: 20,
		eggGroups: ["Water 2", "Dragon"],
		otherFormes: ["Gyarados-Mega", "Gyarados-Kemetis"],
		formeOrder: ["Gyarados", "Gyarados-Mega", "Gyarados-Kemetis"],
	},
	gyaradosmega: {
		num: 130,
		name: "Gyarados-Mega",
	...
	porygon: {
		...
		evos: ["Porygon2"],
		eggGroups: ["Mineral"],
		otherFormes: ["Porygon-Kemetis"],
		formeOrder: ["Porygon", "Porygon-Kemetis"],
	},
	omanyte: {
		num: 138,
		name: "Omanyte",
	...
	dragonite: {
		...
		evoLevel: 55,
		eggGroups: ["Water 1", "Dragon"],
		otherFormes: ["Dragonite-Kemetis"],
		formeOrder: ["Dragonite", "Dragonite-Kemetis"],
	},
	mewtwo: {
		num: 150,
		name: "Mewtwo",
	...
	bayleef: {
		...
		prevo: "Chikorita",
		evoLevel: 16,
		evos: ["Meganium", "Meganium-Kemetis"],
		eggGroups: ["Monster", "Grass"],
	},
	meganium: {
		num: 154,
	...
	crobat: {
		...
		evoType: "levelFriendship",
		eggGroups: ["Flying"],
		otherFormes: ["Crobat-Kemetis"],
		formeOrder: ["Crobat", "Crobat-Kemetis"],
	},
	chinchou: {
		num: 170,
		name: "Chinchou",
	...
	cleffa: {
		...
		eggGroups: ["Undiscovered"],
		canHatch: true,
		otherFormes: ["Cleffa-Kemetis"],
		formeOrder: ["Cleffa", "Cleffa-Kemetis"],
	},
	igglybuff: {
		num: 174,
		name: "Igglybuff",
	...
	natu: {
		...
		evos: ["Xatu"],
		eggGroups: ["Flying"],
		otherFormes: ["Natu-Kemetis"],
		formeOrder: ["Natu", "Natu-Kemetis"],
	},
	xatu: {
		num: 178,
		name: "Xatu",
		...
		evoLevel: 25,
		eggGroups: ["Flying"],
		otherFormes: ["Xatu-Kemetis"],
		formeOrder: ["Xatu", "Xatu-Kemetis"],
	},
	mareep: {
		num: 179,
		name: "Mareep",
		...
		evos: ["Flaaffy"],
		eggGroups: ["Monster", "Field"],
		otherFormes: ["Mareep-Kemetis"],
		formeOrder: ["Mareep", "Mareep-Kemetis"],
	},
	flaaffy: {
		num: 180,
		name: "Flaaffy",
		...
		evos: ["Ampharos"],
		eggGroups: ["Monster", "Field"],
		otherFormes: ["Flaaffy-Kemetis"],
		formeOrder: ["Flaaffy", "Flaaffy-Kemetis"],
	},
	ampharos: {
		num: 181,
		name: "Ampharos",
		...
		evoLevel: 30,
		eggGroups: ["Monster", "Field"],
		otherFormes: ["Ampharos-Mega", "Ampharos-Kemetis"],
		formeOrder: ["Ampharos", "Ampharos-Mega", "Ampharos-Kemetis"],
	},
	ampharosmega: {
		num: 181,
		name: "Ampharos-Mega",
	...
	aipom: {
		...
		evos: ["Ambipom"],
		eggGroups: ["Field"],
		otherFormes: ["Aipom-Kemetis"],
		formeOrder: ["Aipom", "Aipom-Kemetis"],
	},
	sunkern: {
		num: 191,
		name: "Sunkern",
	...
	marshtomp: {
		...
		prevo: "Mudkip",
		evoLevel: 16,
		evos: ["Swampert", "Swampert-Kemetis"],
		eggGroups: ["Monster", "Water 1"],
	},
	swampert: {
		num: 260,
	...
	ralts: {
		...
		evos: ["Kirlia"],
		eggGroups: ["Human-Like", "Amorphous"],
		otherFormes: ["Ralts-Kemetis"],
		formeOrder: ["Ralts", "Ralts-Kemetis"],
	},
	kirlia: {
		num: 281,
		name: "Kirlia",
		...
		eggGroups: ["Human-Like", "Amorphous"],
		otherFormes: ["Kirlia-Kemetis"],
		formeOrder: ["Kirlia", "Kirlia-Kemetis"],
	},
	gardevoir: {
		num: 282,
		name: "Gardevoir",
	...
	sableye: {
		...
		color: "Purple",
		eggGroups: ["Human-Like"],
		otherFormes: ["Sableye-Mega", "Sableye-Kemetis", "Sableye-Guardian"],
		formeOrder: ["Sableye", "Sableye-Mega", "Sableye-Kemetis", "Sableye-Guardian"],
	},
	sableyemega: {
		num: 302,
		name: "Sableye-Mega",
	...
	mawile: {
		...
		color: "Black",
		eggGroups: ["Field", "Fairy"],
		otherFormes: ["Mawile-Mega", "Mawile-Kemetis"],
		formeOrder: ["Mawile", "Mawile-Mega", "Mawile-Kemetis"],
	},
	mawilemega: {
		num: 303,
		name: "Mawile-Mega",
	...
	swablu: {
		...
		evos: ["Altaria"],
		eggGroups: ["Flying", "Dragon"],
		otherFormes: ["Swablu-Kemetis"],
		formeOrder: ["Swablu", "Swablu-Kemetis"],
	},
	altaria: {
		num: 334,
		name: "Altaria",
		...
		evoLevel: 35,
		eggGroups: ["Flying", "Dragon"],
		otherFormes: ["Altaria-Mega", "Altaria-Kemetis"],
		formeOrder: ["Altaria", "Altaria-Mega", "Altaria-Kemetis"],
	},
	altariamega: {
		num: 334,
		name: "Altaria-Mega",
	...
	zangoose: {
		...
		color: "White",
		eggGroups: ["Field"],
		otherFormes: ["Zangoose-Kemetis"],
		formeOrder: ["Zangoose", "Zangoose-Kemetis"],
	},
	seviper: {
		num: 336,
		name: "Seviper",
		...
		color: "Black",
		eggGroups: ["Field", "Dragon"],
		otherFormes: ["Seviper-Kemetis"],
		formeOrder: ["Seviper", "Seviper-Kemetis"],
	},
	lunatone: {
		num: 337,
		name: "Lunatone",
	...
	baltoy: {
		...
		evos: ["Claydol"],
		eggGroups: ["Mineral"],
		otherFormes: ["Baltoy-Kemetis"],
		formeOrder: ["Baltoy", "Baltoy-Kemetis"],
	},
	claydol: {
		num: 344,
		name: "Claydol",
		...
		evoLevel: 36,
		eggGroups: ["Mineral"],
		otherFormes: ["Claydol-Kemetis"],
		formeOrder: ["Claydol", "Claydol-Kemetis"],
	},
	lileep: {
		num: 345,
		name: "Lileep",
	...
	relicanth: {
		...
		color: "Gray",
		eggGroups: ["Water 1", "Water 2"],
		otherFormes: ["Relicanth-Guardian"],
		formeOrder: ["Relicanth", "Relicanth-Guardian"],
	},
	luvdisc: {
		num: 370,
		name: "Luvdisc",
	...
	ambipom: {
		...
		evoMove: "Double Hit",
		eggGroups: ["Field"],
		otherFormes: ["Ambipom-Kemetis"],
		formeOrder: ["Ambipom", "Ambipom-Kemetis"],
	},
	drifloon: {
		num: 425,
		name: "Drifloon",
	...
	gallade: {
		...
		evoItem: "Dawn Stone",
		eggGroups: ["Human-Like", "Amorphous"],
		otherFormes: ["Gallade-Mega", "Gallade-Kemetis"],
		formeOrder: ["Gallade", "Gallade-Mega", "Gallade-Kemetis"],
	},
	gallademega: {
		num: 475,
		name: "Gallade-Mega",
	...
	cofagrigus: {
		...
		evoLevel: 34,
		eggGroups: ["Mineral", "Amorphous"],
		otherFormes: ["Cofagrigus-Guardian"],
		formeOrder: ["Cofagrigus", "Cofagrigus-Guardian"],
	},
	tirtouga: {
		num: 564,
		name: "Tirtouga",
	...
	solosis: {
		...
		evos: ["Duosion"],
		eggGroups: ["Amorphous"],
		otherFormes: ["Solosis-Kemetis"],
		formeOrder: ["Solosis", "Solosis-Kemetis"],
	},
	duosion: {
		num: 578,
		name: "Duosion",
		...
		evos: ["Reuniclus"],
		eggGroups: ["Amorphous"],
		otherFormes: ["Duosion-Kemetis"],
		formeOrder: ["Duosion", "Duosion-Kemetis"],
	},
	reuniclus: {
		num: 579,
		name: "Reuniclus",
		...
		evoLevel: 41,
		eggGroups: ["Amorphous"],
		otherFormes: ["Reuniclus-Kemetis"],
		formeOrder: ["Reuniclus", "Reuniclus-Kemetis"],
	},
	ducklett: {
		num: 580,
		name: "Ducklett",
	...
	foongus: {
		...
		evos: ["Amoonguss"],
		eggGroups: ["Grass"],
		otherFormes: ["Foongus-Kemetis"],
		formeOrder: ["Foongus", "Foongus-Kemetis"],
	},
	amoonguss: {
		num: 591,
		name: "Amoonguss",
		...
		evoLevel: 39,
		eggGroups: ["Grass"],
		otherFormes: ["Amoonguss-Kemetis"],
		formeOrder: ["Amoonguss", "Amoonguss-Kemetis"],
	},
	frillish: {
		num: 592,
		name: "Frillish",
	...
	elgyem: {
		...
		evos: ["Beheeyem"],
		eggGroups: ["Human-Like"],
		otherFormes: ["Elgyem-Kemetis"],
		formeOrder: ["Elgyem", "Elgyem-Kemetis"],
	},
	beheeyem: {
		num: 606,
		name: "Beheeyem",
		...
		evoLevel: 42,
		eggGroups: ["Human-Like"],
		otherFormes: ["Beheeyem-Kemetis"],
		formeOrder: ["Beheeyem", "Beheeyem-Kemetis"],
	},
	litwick: {
		num: 607,
		name: "Litwick",
	...
	bouffalant: {
		...
		color: "Brown",
		eggGroups: ["Field"],
		otherFormes: ["Bouffalant-Kemetis"],
		formeOrder: ["Bouffalant", "Bouffalant-Kemetis"],
	},
	rufflet: {
		num: 627,
		name: "Rufflet",
	...
	salazzle: {
		...
		evoLevel: 33,
		eggGroups: ["Monster", "Dragon"],
		otherFormes: ["Salazzle-Totem", "Salazzle-Kemetis"],
		formeOrder: ["Salazzle", "Salazzle-Totem", "Salazzle-Kemetis"],
	},
	salazzletotem: {
		num: 758,
		name: "Salazzle-Totem",
	...
	hatterene: {
		...
		evoLevel: 42,
		eggGroups: ["Fairy"],
		cosmeticFormes: ["Hatterene-Halloween"],
		formeOrder: ["Hatterene", "Hatterene-Halloween"],
		canGigantamax: "G-Max Smite",
	},
	hatterenegmax: {
		num: 858,
	...
	falinks: {
		...
		color: "Yellow",
		eggGroups: ["Fairy", "Mineral"],
		otherFormes: ["Falinks-Kemetis"],
		formeOrder: ["Falinks", "Falinks-Kemetis"],
	},
	pincurchin: {
		num: 871,
		name: "Pincurchin",
	...
	relicanthguardian: {
		num: 369,
		name: "Relicanth-Guardian",
		baseSpecies: "Relicanth",
		forme: "Guardian",
		types: ["Water", "Rock"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 4000, atk: 90, def: 130, spa: 45, spd: 65, spe: 55},
		abilities: {0: "Guardian Of Change"},
		heightm: 1,
		weightkg: 23.4,
		color: "Gray",
		eggGroups: ["Water 1", "Water 2"],
	...
	cofagrigusguardian: {
		num: 563,
		name: "Cofagrigus-Guardian",
		baseSpecies: "Cofagrigus",
		forme: "Guardian",
		types: ["Ghost"],
		baseStats: {hp: 3900, atk: 50, def: 145, spa: 95, spd: 105, spe: 30},
		abilities: {0: "Guardian Of Curses"},
		heightm: 1.7,
		weightkg: 76.5,
		color: "Yellow",
		prevo: "Yamask",
	...
	sableyeguardian: {
		num: 302,
		name: "Sableye-Guardian",
		baseSpecies: "Sableye",
		forme: "Guardian",
		types: ["Rock", "Ghost"],
		baseStats: {hp: 4300, atk: 80, def: 75, spa: 50, spd: 70, spe: 55},
		abilities: {0: "Guardian Of Sorcery"},
		heightm: 0.5,
		weightkg: 11,
		color: "Brown",
		eggGroups: ["Human-Like"],
