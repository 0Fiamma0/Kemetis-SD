...
export const Formats: FormatList = [
	...
	{
		name: "[Gen 9] Kemetis Almost Any Ability",
		...
		mod: 'gen9',
		ruleset: ['Standard NatDex', '!Obtainable Abilities', 'Ability Clause = 1', 'Sleep Moves Clause', 'Terastal Clause', 'Z-Move Clause'],
		banlist: [
			// Your specific bans
			...
			'Solgaleo', 'Spectrier', 'Urshifu', 'Urshifu-Rapid-Strike', 'Weavile', 'Zacian', 'Zacian-Crowned', 'Zekrom', 'Dragonite', 'Volcarona', 'Lediogre',
        
			// Additional legendary/mythical Pokemon from my original list (not already covered above)
			'Articuno', 'Zapdos', 'Moltres', 'Mew', 'Raikou', 'Entei', 'Suicune', 'Celebi',
			'Regirock', 'Regice', 'Registeel', 'Latios', 'Latias', 'Jirachi', 'Deoxys', 'Deoxys-Speed', 'Deoxys-Defense',
			'Heatran', 'Cresselia', 'Phione', 'Manaphy', 'Shaymin', 'Victini', 'Cobalion', 'Terrakion', 'Virizion', 
			...
			'Iron Treads', 'Iron Hands', 'Iron Jugulis', 'Iron Moth', 'Iron Thorns', 'Iron Leaves', 'Iron Boulder', 'Iron Crown',
        
			// Ultra Beasts
			'Nihilego', 'Buzzwole', 'Pheromosa', 'Xurkitree', 'Celesteela', 'Kartana', 'Guzzlord', 'Poipole', 'Naganadel', 'Stakataka', 'Blacephalon',
        
			// Combined ability bans (yours + mine)
			'Arena Trap', 'Comatose', 'Contrary', 'Fluffy', 'Fur Coat', 'Good as Gold', 'Gorilla Tactics', 'Huge Power', 'Ice Scales', 
			'Illusion', 'Imposter', 'Innards Out', 'Intrepid Sword', 'Libero', 'Magic Bounce', 'Magnet Pull', 'Moody', 
			'Neutralizing Gas', 'Orichalcum Pulse', 'Parental Bond', 'Poison Heal', 'Protean', 'Pure Power', 'Shadow Tag', 
			'Simple', 'Speed Boost', 'Stakeout', 'Triage', 'Unburden', 'Water Bubble', 'Wonder Guard', 'Salamencite', 'Gengarite',
        
			// Banned Ability + Pokemon combinations
			'Chansey + Magic Guard', 'Shedinja + Sturdy', 'Blissey + Magic Guard',
        
			// Items and moves
			'King\'s Rock', 'Razor Fang', 'Baton Pass', 'Last Respects', 'Revival Blessing', 'Shed Tail',
		],
		unbanlist: [
			'Dragonite-Kemetis', // Allow your custom form
		],
	},
	{
		name: "[Gen 9] Kemetis Godly Gift",
	...
	},
	{
		...
		mod: 'gen9',
		ruleset: ['Standard NatDex', 'Species Clause', 'Item Clause', 'Z-Move Clause', 'Sleep Moves Clause', 'Terastal Clause', 'OHKO Clause'],
		banlist: [
			...
			'Damp Rock', 'Heat Rock', 'Light Clay', 'Baton Pass', 'Beat Up', 'Fake Out', 'Last Respects', 'Shed Tail', 'Stealth Attack', 'Pursuit',
		],
		restricted: [
			'Doom Desire', 'Dynamic Punch', 'Electro Ball', 'Explosion', 'Gyro Ball', 'Final Gambit', 'Flail', 'Fury Cutter', 'Future Sight', 'Grass Knot',
			'Grassy Glide', 'Hard Press', 'Heavy Slam', 'Heat Crash', 'Inferno', 'Low Kick', 'Misty Explosion', 'Nuzzle', 'Power Trip', 'Reversal', 'Self-Destruct',
			'Spit Up', 'Stored Power', 'Tera Blast', 'Weather Ball', 'Zap Cannon', 
		],
		onValidateTeam(team) {
	...
	{
		name: "[Gen 9] Spooky Cup Kemetis Edition",
		threads: [
		...
		mod: 'gen9',
		gameType: 'doubles',
		ruleset: ['Standard NatDex', 'Species Clause', 'Item Clause', 'Z-Move Clause', 'Picked Team Size = 4', 'Max Team Size = 6', 'Max Move Count = 4', 'Max Level = 100', 'Default Level = 100', 'Terastal Clause', 'Open Team Sheets'],
		banlist: ['All Pokemon', 'Mega', 'Gengarite', 'Gardevoirite', 'Ampharosite', 'Venusaurite', 'Charizardite X', 'Charizardite Y', 'Blastoisinite', 
			'Blazikenite', 'Medichamite', 'Houndoominite', 'Aggronite', 'Banettite', 'Tyranitarite', 'Scizorite', 'Pinsirite', 'Aerodactylite', 
			'Lucarionite', 'Abomasite', 'Kangaskhanite', 'Gyaradosite', 'Absolite', 'Alakazite', 'Heracronite', 'Mawilite', 'Manectite', 'Garchompite', 
			'Swampertite', 'Sceptilite', 'Sablenite', 'Altarianite', 'Galladite', 'Audinite', 'Metagrossite', 'Sharpedonite', 'Slowbronite', 'Steelixite', 
			'Pidgeotite', 'Glalitite', 'Diancite', 'Cameruptite', 'Lopunnite', 'Salamencite', 'Beedrillite'],
			unbanlist: [
			'Venusaur', 'Charizard', 'Blastoise', 'Butterfree', 'Beedrill', 'Raticate', 'Raticate-Alola',
			'Fearow', 'Arbok', 'Nidoqueen', 'Nidoking', 'Vileplume', 'Parasect', 'Venomoth', 'Persian-Alola', 'Tentacruel', 'Dodrio', 
			'Muk', 'Muk-Alola', 'Gengar', 'Hypno', 'Marowak-Alola', 'Weezing', 'Weezing-Galar', 'Starmie', 'Jynx', 'Gyarados', 'Ditto', 
			'Pinsir', 'Aerodactyl', 'Omastar', 'Kabutops', 'Meganium', 'Typhlosion', 'Typhlosion-Hisui', 'Feraligatr', 'Noctowl', 'Ariados', 
			'Crobat', 'Espeon', 'Umbreon', 'Slowbro-Galar', 'Slowking-Galar', 'Wobbuffet', 'Granbull', 'Scizor', 'Houndoom', 'Heracross', 
			'Corsola-Galar', 'Tyranitar', 'Sceptile', 'Blaziken', 'Swampert', 'Mightyena', 'Dustox', 'Shiftry', 'Ninjask', 'Shedinja', 
			'Exploud', 'Sableye', 'Mawile', 'Aggron', 'Manectric', 'Swalot', 'Sharpedo', 'Flygon', 'Cacturne', 'Zangoose', 'Seviper', 'Lunatone', 
			'Crawdaunt', 'Claydol', 'Cradily', 'Armaldo', 'Banette', 'Absol', 'Glalie', 'Huntail', 'Gorebyss', 'Torterra', 'Infernape', 'Empoleon', 
			'Luxray', 'Roserade', 'Rampardos', 'Vespiquen', 'Drifblim', 'Mismagius', 'Honchkrow', 'Purugly', 'Skuntank', 'Bronzong', 'Spiritomb', 
			'Drapion', 'Toxicroak', 'Carnivine', 'Abomasnow', 'Weavile', 'Tangrowth', 'Yanmega', 'Gliscor', 'Dusknoir', 'Froslass', 'Rotom', 
			'Rotom-Fan', 'Rotom-Frost', 'Rotom-Heat', 'Rotom-Mow', 'Rotom-Wash', 'Serperior', 'Emboar', 'Samurott', 'Samurott-Hisui', 'Watchog',
			'Liepard', 'Conkeldurr', 'Seismitoad', 'Scolipede', 'Krookodile', 'Scrafty', 'Sigilyph', 'Cofagrigus', 'Garbodor', 'Zoroark',
			'Zoroark-Hisui', 'Gothitelle', 'Reuniclus', 'Jellicent', 'Galvantula', 'Beheeyem', 'Chandelure', 'Cryogonal', 'Stunfisk', 'Stunfisk-Galar', 
			'Druddigon', 'Golurk', 'Mandibuzz', 'Heatmor', 'Durant', 'Hydreigon', 'Volcarona', 'Chesnaught', 'Delphox', 'Greninja', 'Pangoro', 
			'Meowstic', 'Meowstic-F', 'Aegislash', 'Aromatisse', 'Malamar', 'Barbaracle', 'Dragalge', 'Clawitzer', 'Trevenant', 'Gourgeist', 'Noivern', 
			'Decidueye', 'Decidueye-Hisui', 'Incineroar', 'Primarina', 'Gumshoos', 'Vikavolt', 'Crabominable', 'Lycanroc', 'Lycanroc-Midnight', 
			'Lycanroc-Dusk', 'Wishiwashi', 'Toxapex', 'Araquanid', 'Shiinotic', 'Salazzle', 'Golisopod', 'Mimikyu', 'Bruxish', 'Dhelmise', 'Rillaboom', 
			'Cinderace', 'Inteleon', 'Corviknight', 'Orbeetle', 'Thievul', 'Drednaw', 'Coalossal', 'Sandaconda', 'Barraskewda', 'Toxtricity', 
			'Centiskorch', 'Grapploct', 'Polteageist', 'Hatterene', 'Grimmsnarl', 'Obstagoon', 'Perrserker', 'Cursola', 'Runerigus', 'Falinks', 
			'Morpeko', 'Dragapult', 'Wyrdeer', 'Kleavor', 'Basculegion', 'Basculegion-F', 'Overqwil', 'Meowscarada', 'Skeledirge', 'Quaquaval', 
			'Spidops', 'Lokix', 'Armarouge', 'Ceruledge', 'Mabosstiff', 'Grafaiai', 'Brambleghast', 'Toedscruel', 'Klawf', 'Scovillain', 'Bombirdier', 
			'Revavroom', 'Glimmora', 'Houndstone', 'Cetitan', 'Veluza', 'Annihilape', 'Kingambit', 'Gholdengo', 'Sinistcha', 'Hydrapple', 'Altaria-Kemetis', 
			'Ampharos-Kemetis', 'Arbok-Kemetis', 'Beheeyem-Kemetis', 'Bouffalant-Kemetis', 'Claydol-Kemetis', 'Clefable-Kemetis', 
			'Delphox-Kemetis', 'Dragonite-Kemetis', 'Falinks-Kemetis', 'Gallade-Kemetis', 'Gyarados-Kemetis', 'Meganium-Kemetis', 'Salazzle-Kemetis', 
			'Seviper-Kemetis', 'Swampert-Kemetis', 'Wigglytuff-Kemetis', 'Xatu-Kemetis', 'Zangoose-Kemetis', 'Lediogre', 
			'Ledyarkle', 'Meerserve', 'Reuniclus-Kemetis', 'Sunflare', 'Toucannon-Kemetis', 'Toucannon'],	
	},
	{
		section: "Custom Formats",
	},
	{
		name: "[TERA] Triples Custom Game",
	...
	},
	{
		...
		battle: {trunc: Math.trunc},
		// no restrictions, for serious (other than team preview)
		ruleset: ['Team Preview', 'Cancel Mod', 'Terastal Clause', 'Max Team Size = 6', 'Max Move Count = 4', 'Max Level = 100', 'Default Level = 100'],
	},
	{
		name: "[SFIDA] Lotta In Palestra (Doppio 4v4)",
		...
		battle: {trunc: Math.trunc},
		// no restrictions, for serious (other than team preview)
		ruleset: ['Team Preview', 'Cancel Mod', 'Terastal Clause', 'Picked Team Size = 4', 'Max Team Size = 6', 'Max Move Count = 4', 'Max Level = 100', 'Default Level = 100'],
	},
	{
		name: "[SFIDA] Lotta In Palestra (Doppio 6v6)",
